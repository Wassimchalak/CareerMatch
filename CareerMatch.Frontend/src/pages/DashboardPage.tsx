...
function DashboardPage() {const navigate = useNavigate();
const location = useLocation();const [loadingMessageIndex, setLoadingMessageIndex] = useState(0);const [cvUploadMessageIndex, setCvUploadMessageIndex] =useState(0);
